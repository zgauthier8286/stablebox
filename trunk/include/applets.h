...
USE_LLAD(APPLET(llad, _BB_DIR_USR_SBIN, _BB_SUID_NEVER))
...
USE_PING(APPLET(ping, _BB_DIR_BIN, _BB_SUID_NEVER))
...
USE_SU(APPLET(su, _BB_DIR_BIN, _BB_SUID_MAYBE))
...
USE_TRACEROUTE(APPLET(traceroute, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
